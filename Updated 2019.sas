...
run;
    proc logistic data=regression;
		class age_cat(ref = "30 to 34") product (ref = 'PPO Commercial') deliveryear (ref = '2008') pat_region (ref = "E") term (ref = "1")/ param= ref;
        model user_preg (event="1")= pre_user age_cat  product  deliveryear  pat_region term ;
